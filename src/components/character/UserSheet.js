        ...
        <div className="space-y-6 lg:col-span-1 max-w-md mx-auto">
            <Card>
                ...
                <div className="space-y-4">
                    ...
                    <EditableField isTextarea rows={5} label="유저 노트" value={localCharacter.note || ''} onChange={e => handleLocalChange('note', e.target.value)} placeholder="AI가 참고할 유저의 핵심 컨셉이나 키워드를 서술합니다."/>
                </div>
            </Card>
        </div>
    );
